...
public class StudentMain {
	...
	StudentMain sobj=new StudentMain();
	
	static Student data[]=new Student[4];//here memory is not located but just the reference 


	
	static{
		for (int i = 0; i < data.length; i++)
			data [i]= new Student();//now the memory is located to objects
